...
<p data-sourcepos="9:1-9:169"><a href="https://shardz.moogi.tech/verify?token={token}"><strong><span class="pending">Verify email</span></strong></a></p>
...
def send_password_reset_email(name, email, token, ip2l):
    ...
    message = f"""
        ...
        <p data-sourcepos="9:1-9:169"><a href="https://shardz.moogi.tech/reset-password?token={token}"><strong><span class="pending">Reset password</span></strong></a></p>
